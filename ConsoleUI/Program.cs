...
//         {
//             DalApi.IDAL dalObj = DalObject.DalObject.GetInstance(); // Singleton
//             MenuWindowHandle(dalObj);
//         }
//
//         static void MenuWindowHandle(DalApi.IDAL dalObj)
//         {
//             char ch = '0';
//             MenuOptionsE op;
//
...
//         }
//
//         static void InsertOptionsWindowHandle(DalApi.IDAL dalObj)
//         {
//             char ch = '0';
//             InsertOptionsE op;
//
...
//                     try
//                     {
//                         dalObj.AddStation(id, name, new DalApi.DO.Location(lattitude, longitude), chargeSlots);
...
//                     try
//                     {
//                         dalObj.AddDrone(id, model, (DalApi.DO.WeightCategories) maxWeight, battery);
//                         Console.WriteLine("Success.\n");
//                         pause();
//                     }
//
...
//                     try
//                     {
//                         dalObj.AddCostumer(id, name, phone, new DalApi.DO.Location(lattitude, longitude));
//                         Console.WriteLine("Success.\n");
//                         pause();
//                     }
//
...
//         }
//
//         static void UpdateOptionsWindowHandle(DalApi.IDAL dalObj)
//         {
//             char ch = '0';
//             UpdateOptionsE op;
//
...
//         }
//
//         static void DisplayOptionsWindowHandle(DalApi.IDAL dalObj)
//         {
//             char ch = '0';
//             DisplayOptionsE op;
//
...
//         }
//
//         static void ListViewOptionsWindowHandle(DalApi.IDAL dalObj)
//         {
//             char ch = '0';
//             ListViewOptionsE op;
//
